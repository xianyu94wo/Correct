...
def correct(pathF, bias, omiga, pathS, eEle):
    ...
    arFC = arZD - bias
    np.savetxt(pathS + '24hTemp.txt', arFC, format('%.2f'))

    with open(pathS + '24hTemp.txt') as f1:
    ...
    os.remove(pathS + '24hTemp.txt')

def mkdir_dir_and_ormiga():
    path1 = 'F:\\work\\2020Correct\\data\\DA\\'
    listOmiga = ['{:.3f}'.format(0.005 * x) for x in range(25, 50)]
