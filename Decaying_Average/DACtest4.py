...
def correct(pathF, bias, omiga, pathS, eEle):
    arZD = np.loadtxt(pathF)
    arFC = arZD - bias
    np.savetxt(pathS + '24hTemp4.txt', arFC, format('%.2f'))

    with open(pathS + '24hTemp4.txt') as f1:
        tempStr = f1.readlines()
    with open('{}{}\\{}\\{}.024'.format(pathS, '{:.3f}'.format(omiga), eEle,nowTime[2:]), 'w') as f2:
    ...
    os.remove(pathS + '24hTemp4.txt')

def mkdir_dir_and_ormiga():
    path1 = 'F:\\work\\2020Correct\\data\\DA\\'
    listOmiga = ['{:.3f}'.format(0.005 * x) for x in range(127, 200)]
...
if __name__ == '__main__':
    ...
    pathS = 'F:\\work\\2020Correct\\data\\DA\\'
            ...
            for eStep in slidingStep:
                ...
                for eEle in listEle:
                    ...
                    try:
                        ...
                        result = correct(pathF, bias, omiga, pathS, eEle)
