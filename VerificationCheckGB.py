...
if __name__ == '__main__':
    ...
    pathS = 'F:\\work\\2020Correct\\data\\verificationResultCheck\\'
    pathZ = 'F:\\work\\2020Correct\\data\\TM_md_24h_Grid\\'
    duringDay = 20
    dataStart = '2020041009'
    duringDayS = 335
    ...
    ###############################################################
        for eEle in element:
            print(eEle)
            aa = get_correct_verification(pathO, pathM1, pathZ, eEle, listTime)
            ...
            np.savetxt('{}skilleDayforePoint_{}_{}days_{}_MB.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       skilleDayforePoint, fmt='%.4f')
            np.savetxt('{}diffFceDayforePointABS_{}_{}days_{}_MB.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       diffFceDayforePoint, fmt='%.4f')
            np.savetxt('{}diffZdeDayforePointABS_{}_{}days_{}_MB.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       diffZdeDayforePoint, fmt='%.4f')
            np.savetxt('{}diffFceDayforePoint_{}_{}days_{}_MB.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       diffFceDayforePoint, fmt='%.4f')
            np.savetxt('{}diffZdeDayforePoint_{}_{}days_{}_MB.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       diffZdeDayforePoint, fmt='%.4f')
            dfSkilleDayforALL.to_csv('{}listSkilleDayforALL_{}_{}days_{}_MB.txt'.format(pathS, listTime[-1], duringDay, eEle),
                                     float_format='%.2f')
            dfRate.to_csv('{}listRateForALL_{}_{}days_{}_MB.txt'.format(pathS, listTime[-1], duringDay, eEle),
                          float_format='%.2f')


            bb = get_correct_verification(pathO, pathM2, pathZ, eEle, listTime)
            skilleDayforePoint, diffFceDayforePointAbs, diffZdeDayforePointAbs, diffFceDayforePoint, diffZdeDayforePoint, dfSkilleDayforALL, dfRate = bb
            np.savetxt('{}skilleDayforePoint_{}_{}days_{}_DA.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       skilleDayforePoint, fmt='%.4f')
            np.savetxt('{}diffFceDayforePointABS_{}_{}days_{}_DA.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       diffFceDayforePoint, fmt='%.4f')
            np.savetxt('{}diffZdeDayforePointABS_{}_{}days_{}_DA.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       diffZdeDayforePoint, fmt='%.4f')
            np.savetxt('{}diffFceDayforePoint_{}_{}days_{}_DA.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       diffFceDayforePoint, fmt='%.4f')
            np.savetxt('{}diffZdeDayforePoint_{}_{}days_{}_DA.txt'.format(pathS, listTime[-1], duringDay, eEle),
                       diffZdeDayforePoint, fmt='%.4f')
            dfSkilleDayforALL.to_csv('{}listSkilleDayforALL_{}_{}days_{}_DA.txt'.format(pathS, listTime[-1], duringDay, eEle),
                                     float_format='%.2f')
            dfRate.to_csv('{}listRateForALL_{}_{}days_{}_DA.txt'.format(pathS, listTime[-1], duringDay, eEle),
                          float_format='%.2f')
        #########################################################
    print('DONE')
