...
class CalculateAdjust(object):
    ...
    def __init__(self, element, SlidingStep):
    ...
    def calculate_median(self, diffDf, baseDf):
        '''
        求中位数和D中位数
        :param diffDf: diffDf
        :param baseDf: baseDf
    ...
    def calculate_omiga(self, diffDf, medianArray, DMedianArray):
        '''
        计算Ω
        :param diffDf: diffDf
    ...
    def calculate_adjustDeno(self, diffDf, baseDf):
        '''
        计算adjust第二项的分母
        :param diffDf: diffDf
        :param baseDf: baseDf
    ...
    def calculate_adjustNumer(self, diffDf, baseDf, medianArray):
        '''
        计算adjust第二项的分子
        :param diffDf: diffDf
        :param baseDf: baseDf
        ...
        '''
        for i in range(1, SlidingStep + 1):
            diffDf['adjustNumer' + str(i)] = (diffDf[self.element + 'diff' + str(i)] - medianArray) * (1 - diffDf['omiga' + str(i)] ** 2) ** 2
...
if __name__ == '__main__':
    ...
    pathS = 'F:\\work\\2020Correct\\data\\TM_Result_648\\'
    ...
    for eEle in element:
        # print(eEle)
        ob1 = CalculateAdjust(eEle, SlidingStep)
        all_attribute_of_object(ob1)
        diffDf1 = ob1.get_diff_dataframe(pathM, pathO, baseDf)
        diffDfBase = ob1.calculate_median(diffDf1, baseDf)
        diffDf2, medianArray, DMedianArray = diffDfBase[0], diffDfBase[1], diffDfBase[2]
        diffDf3 = ob1.calculate_omiga(diffDf2, medianArray, DMedianArray)
        adjustDeno = ob1.calculate_adjustDeno(diffDf3, baseDf)
        adjustNumer = ob1.calculate_adjustNumer(diffDf3, baseDf, medianArray)
