...
class ABC(object):
    ...
    def __init__(self, element, gridBasePath):
        '''
...
if __name__ == '__main__':
    ...
    for eEle in element:
        ...
        with open(pathGridS + eEle + '\\' + gridFileSaveName, 'w') as f2:
            ...
            f2.write('20%s %s %s %s 24 0 %s' % (gridFileSaveName[:-10], gridFileSaveName[2:4], gridFileSaveName[4:6], gridFileSaveName[6:8], '\n'))
