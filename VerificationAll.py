...
if __name__ == '__main__':
    ...
    pathM3 = 'F:\\work\\2020Correct\\data\\TM_Result_Combine_2\\'
    ...
    for eEle in element:
        print(eEle)
        aa = get_correct_verification(pathO, pathM3, pathZ, eEle, listTime)
        ...
        np.savetxt('{}skilleDayforePoint_{}_{}days_{}_CB2.txt'.format(pathS, listTime[-1], duringDay, eEle),
                   skilleDayforePoint, fmt='%.4f')
        np.savetxt('{}diffFceDayforePointABS_{}_{}days_{}_CB2.txt'.format(pathS, listTime[-1], duringDay, eEle),
                   diffFceDayforePoint, fmt='%.4f')
        np.savetxt('{}diffZdeDayforePointABS_{}_{}days_{}_CB2.txt'.format(pathS, listTime[-1], duringDay, eEle),
                   diffZdeDayforePoint, fmt='%.4f')
        np.savetxt('{}diffFceDayforePoint_{}_{}days_{}_CB2.txt'.format(pathS, listTime[-1], duringDay, eEle),
                   diffFceDayforePoint, fmt='%.4f')
        np.savetxt('{}diffZdeDayforePoint_{}_{}days_{}_CB2.txt'.format(pathS, listTime[-1], duringDay, eEle),
                   diffZdeDayforePoint, fmt='%.4f')
        dfSkilleDayforALL.to_csv('{}listSkilleDayforALL_{}_{}days_{}_CB2.txt'.format(pathS, listTime[-1], duringDay, eEle),
                                 float_format='%.2f')
        dfRate.to_csv('{}listRateForALL_{}_{}days_{}_CB2.txt'.format(pathS, listTime[-1], duringDay, eEle),
                      float_format='%.2f')
